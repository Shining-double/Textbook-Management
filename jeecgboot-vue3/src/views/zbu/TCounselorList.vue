<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
          ...
          <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'zbu:t_counselor:deleteBatch'">批量操作
    ...
    <!-- 表单区域 -->
    <TCounselorModal @register="registerModal" @success="handleSuccess"></TCounselorModal>
  </div>
</template>

<script lang="ts" name="zbu-tCounselor" setup>
