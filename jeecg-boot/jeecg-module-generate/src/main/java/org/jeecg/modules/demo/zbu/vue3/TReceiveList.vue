<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <TReceiveModal @register="registerModal" @success="handleSuccess"></TReceiveModal>
  </div>
</template>
...
<script lang="ts" name="zbu-tReceive" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './TReceive.api';
