<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <StudentBillModal @register="registerModal" @success="handleSuccess"></StudentBillModal>
  </div>
</template>
...
<script lang="ts" name="zbu-studentBill" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './StudentBill.api';
