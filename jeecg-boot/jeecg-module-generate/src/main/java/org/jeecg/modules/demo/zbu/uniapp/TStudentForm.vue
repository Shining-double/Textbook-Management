    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">学生姓名：</text></view>
                  <input  placeholder="请输入学生姓名" v-model="model.studentName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">入学年份：</text></view>
                  <input  placeholder="请输入入学年份" v-model="model.admissionYear"/>
                </view>
              </view>
				<view class="padding">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/zbu/tStudent/queryById",
                  add: "/zbu/tStudent/add",
                  edit: "/zbu/tStudent/edit",
                },
            }
        },
        created(){
