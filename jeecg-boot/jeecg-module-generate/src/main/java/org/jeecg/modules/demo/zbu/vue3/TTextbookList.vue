   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
          ...
          <a-button  type="primary" v-auth="'zbu:t_textbook:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
          <j-upload-button type="primary" v-auth="'zbu:t_textbook:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
...
<script lang="ts" name="zbu-tTextbook" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './TTextbook.api';
