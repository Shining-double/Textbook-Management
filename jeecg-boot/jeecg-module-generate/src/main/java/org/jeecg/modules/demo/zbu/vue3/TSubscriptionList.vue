<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <TSubscriptionModal @register="registerModal" @success="handleSuccess"></TSubscriptionModal>
  </div>
</template>
...
<script lang="ts" name="zbu-tSubscription" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './TSubscription.api';
       ...
       return [
         {
           ...
           auth: 'zbu:t_subscription:delete'
         }
       ]
   }
